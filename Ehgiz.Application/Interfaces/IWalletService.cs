...
public interface IWalletService
{
    ...
    Task<TopUpResponse> InitiateTopUpAsync(int userId, TopUpRequest request);
    Task CreditWalletFromStripeAsync(string paymentIntentId, int userId, decimal amount);
